...
const ProductGrid = () => {
  const products = [
    { id: 1, name: "The Dandy Chair", price: "250", image: "/chair.jpg" },
    { id: 2, name: "Rustic Vase Set", price: "155", image: "/vase.jpg" },
    { id: 3, name: "The Silky Vase", price: "125", image: "/silkyvase.jpg" },
    { id: 4, name: "The Lucy Lamp", price: "399", image: "/lamp.jpg" },
  ];
  ...
  return (
    <section className="py-16 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
      <h2
        className={`text-3xl md:text-4xl font-serif text-center mb-16 font-clash transition-all duration-700 ease-out ${
